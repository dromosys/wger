...
class AdminUserNote(m.Model):
    ...
    user = m.ForeignKey(User,
                        editable=False,
                        related_name='adminusernote_user', on_delete=models.CASCADE)
    '''
    ...
    member = m.ForeignKey(User,
                          editable=False,
                          related_name='adminusernote_member', on_delete=models.CASCADE)
    '''
...
class UserDocument(m.Model):
    ...
    user = m.ForeignKey(User,
                        editable=False,
                        related_name='userdocument_user', on_delete=models.CASCADE)
    '''
    User this note belongs to
    '''
    ...
    member = m.ForeignKey(User,
                          editable=False,
                          related_name='userdocument_member', on_delete=models.CASCADE)
    '''
    Gym member this note refers to
    '''
...
class Contract(m.Model):
    ...
    user = m.ForeignKey(User,
                        editable=False,
                        related_name='contract_user', on_delete=models.CASCADE)
    '''
    ...
    member = m.ForeignKey(User,
                          editable=False,
                          related_name='contract_member', on_delete=models.CASCADE)
    '''
    ...
    contract_type = m.ForeignKey(ContractType,
                                 blank=True,
                                 null=True,
                                 verbose_name=_('Contract type'),on_delete=models.CASCADE)
    '''
