...
urlpatterns = i18n_patterns(
    ...
    url(r'^', include('wger.core.urls',namespace='core'),),
    ...
    url(r'software/', include('wger.software.urls', namespace='software' )), #namespace='software', app_name='software'
    ...
    url(r'email/', include('wger.emails.urls', namespace='email')), 
    url(r'^sitemap\.xml$',
        sitemap,
        {'sitemaps': sitemaps},
        name='sitemap')
